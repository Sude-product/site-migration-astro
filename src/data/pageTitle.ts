...
const QUALIFIERS: Record<Locale, string[]> = {
  ...
  az: ['İK Proqramı', 'İK İdarəetmə Proqramı', 'İnsan Resursları Proqramı', 'İnsan Resursları İdarəetmə Proqramı', 'Bulud Əsaslı İnsan Resursları İdarəetmə Proqramı'],
};
...
const CTA_TEMPLATES: Record<Locale, (keyword: string) => string> = {
  ...
  az: (keyword) => `${keyword} üçün Müraciət Et`,
};
