...
export const AZ_SLUGS = {
  contact: 'elaqe',
  globalBrand: 'qlobal-marka-hedefi',
  whyIdenfit: 'niye-idenfit',
  about: 'haqqimizda',
};
...
// ============================== az (Azerbaycan dili) ==============================
// 2026-08-21 — kullanıcı talimatıyla az tam site kapsamına genişletiliyor,
// diğer locale'lerle AYNI davranış (KARAR 1, TR kaynaktan gerçek/
// profesyonel çeviri). Aşağıdaki 6 sabit (Contact/Global Brand/Why
// idenfit/About/Presentation) TR kaynaktan (`dist/*/index.html` render
// çıktısı + `reference/wordpress-export/*.json` ham verisi) birebir
// çevrildi.

export const CONTACT_AZ_OVERRIDE: ContactContent = {
  pageTitle: 'Hər cür əlaqəyə açığıq',
  pageSubtitle: 'Sinirsiz dəstək və məlumat üçün<br>hər zaman yanınızdayıq!',
  callTitle: 'Bizə zəng edin!',
  callText: '+90 216 295 09 27',
  callLinkUrl: 'tel:+902162950927',
  emailTitle: 'Bizə yazın!',
  emailLinkUrl: 'mailto:hello@idenfit.com',
  formTitle: 'Bizə çatın!',
  officesTitle: 'Ofislərimiz',
  offices: [
    { name: 'İstanbul Mərkəz Ofisi', address: 'Ofis-D. Şerifali Mah. Kale Sk. No:22 Zemin Kat 34775 Ümraniye/İstanbul' },
...
export const GLOBAL_BRAND_AZ_HERO: ProductBlock = {
  title: 'Qlobal Marka & Idenfit',
  text:
...
export const GLOBAL_BRAND_AZ_SECTIONS: ProductBlock[] = [
  {
    title: 'Qlobal Böyümə Vizyonumuz',
    text:
...
export const WHY_IDENFIT_AZ_HERO: ProductBlock = {
  title: 'doğru idarə olunan işçi qüvvəsi ilə müəssisəniz üçün daha yaxşı hədəflərə çatın!',
...
export const WHY_IDENFIT_AZ_SECTIONS: ProductBlock[] = [
  {
    title: '40 yaxşı səbəb <br>idenfit üçün',
    text: '<p><strong>İdenfit-i bu gün istifadə etməyə başlamağınız üçün 40 yaxşı səbəbimiz var.</strong></p>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'Birinci dərəcəli xidmət təminatı',
    text: '<p><strong>Sizi və tələblərinizi əhəmiyyətli hesab edirik. idenfit olaraq göstərdiyimiz xidmətlə sizi xüsusi hiss etdiririk.</strong></p>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'Qazanclar',
    text:
      '<ul class="list gray"><li>İstifadə etdiyiniz qədər aylıq ödəniş edirsiniz</li><li>Hər yerdən və hər zaman sistemə çata bilərsiniz</li><li>İş proseslərini avtomatlaşdırır</li><li>Səmərəliliyi artırır</li><li>Daha yaxşı ünsiyyət üçün zəmin hazırlayır</li><li>İşə uyğunlaşma proseslərini asanlaşdırır</li><li>Daha az işçi dövriyyəsi təmin edir</li><li>Müəssisədaxili davamsızlıqları azaldır</li><li>Əsas işinizə fokuslanmaq üçün vaxta qənaət etdirir</li><li>Əvvəlcədən satınalma investisiyası etmək məcburiyyətində qalmırsınız</li></ul>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'Əsas faydalar',
    text:
      '<ul class="list gray"><li>İstifadəçiyə 20 illik komanda təcrübəsi təqdim edir</li><li>İnsan resursları proseslərini rəqəmsallaşdırır</li><li>Mobil və modul tətbiqlər təqdim edir</li><li>Təhlükəsiz və etibarlı verilənlər bazası təmin edir</li><li>İstifadəçi təlimi verilir</li><li>Pulsuz dəstək təqdim edir</li><li>Almaq, öyrənmək və istifadə etmək asandır</li><li>Yüksək istifadəçi təcrübəsi təmin edir</li><li>Analitik hesabatlar tərtib edir</li><li>Sistemə davamlı innovasiya əlavə olunur</li><li>Populyar tətbiqlər və avadanlıqlarla inteqrasiya ola bilir</li></ul>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'İnfrastruktur',
    text:
      '<ul class="list gray"><li>Java əsaslı memarlıq – güclü infrastrukturla təchiz edilib</li><li>ISO-27001 – İT təhlükəsizliyi (ISO-9001) sertifikatına sahibdir</li><li>Şəxsi məlumatların qorunması qanunvericiliyinə uyğun – məlumat qorunmasını pozmur</li><li>SHA-2 SSL 256-Bit AES – Təhlükəsiz əməliyyatlar aparılır</li><li>Genişlənə bilən və miqyaslana bilən sistem təqdim edir</li><li>Anonimləşdirilmiş məlumatlar – həssas məlumatlar ayrıla bilər</li><li>Avtomatik ehtiyat nüsxələnən verilənlər bazası təmin edir</li><li>Baxım haqqı yoxdur</li><li>Server, verilənlər bazası və ya lisenziya investisiyası tələb etmir</li><li>Amazon Web Services bulud əsaslı platformdur</li></ul>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'Dəstəklər',
    text:
      '<ul class="list gray"><li>Birinci dərəcəli müştəri xidməti təqdim edir</li><li>Pulsuz yeniləmələr / təkmilləşdirmələr / dəstək təqdim edir</li><li>Pulsuz fərdiləşdirmə və inkişaf dəstəyi mövcuddur</li><li>Pulsuz dəstək təqdim edir</li><li>Sürətlə tətbiq oluna bilən xüsusiyyətlərə malikdir</li><li>Müştəriyə üstünlük verir</li><li>İşçilərin müəssisəyə bağlılığını artırır</li><li>Fərdi mobil tətbiq dəstəyi var</li><li>Müştəri məmnunluğu yaradır</li><li>Yerində dəstək tələb etmir</li></ul>',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
...
export const ABOUT_AZ_HERO: ProductBlock = {
  title:
    'Məqsədimiz dünyanın ən yaxşı markalarından biri olmaq və yenilikçi, təzələyici və öncül kimliyimizlə proqram təminatı sənayesində yeni uğurlar əldə etməkdir.',
...
export const ABOUT_AZ_SECTIONS: ProductBlock[] = [
  {
    title: 'tarixçəmiz',
    text:
      '<p>Berlində saat ustası Johann Meyer, 1878-ci ildə Osmanlı İmperiyasının baş saatçısı olaraq İstanbulda bir saat dükanı açdı. Oğlu və nəvələri bu kiçik müəssisəni 5 nəsillik qlobal bir şirkətə çevirdilər. 140 ildən artıqdır "Kim, harada və nə zaman?" suallarına cavab veririk.</p>İnsan resursları və işçi qüvvəsi planlaması sahəsində dünyanın ilk 10 proqram təminatı həllindən biri olmaq üçün səylə çalışırıq. Johann Meyer-dən 140 il əvvəl miras aldığımız dəyərlər idenfit brendi altında davam edir, bizi sahəmizdə daha innovativ və daha yaxşı bir gələcək yaratmağa sövq edir.',
    ctaText: '',
    ctaUrl: '',
    image: null,
  },
  {
    title: 'Burada olmaqdan xoşbəxtik =)',
    text: '',
    ctaText: '',
    ctaUrl: '',
    image: ABOUT_TEAM_PHOTO_IMAGE,
...
export const PRESENTATION_AZ_OVERRIDE: PresentationContent = {
  pageTitle: 'idenfit ilə insan resursları idarəçiliyində sürəti və səmərəliliyi yaşayın.',
  info: [
    '48 saat ərzində hazır, dərhal istifadəyə hazır',
    'Onboarding prosesiniz bizimlə çox asandır',
    'Təhlükəsiz və fasiləsiz məlumat köçürülməsi',
  ],
  callText: 'İndi Zəng Edin',
  phoneNumber: '+90 216 295 09 27',
  phoneNumberLink: 'tel:+902162950927',
