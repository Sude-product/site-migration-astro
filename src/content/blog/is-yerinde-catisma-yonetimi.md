---
slug: is-yerinde-catisma-yonetimi
title: İş Yerinde ÇatışmaYönetimi
...
## 3) Farklı Görüşleri Birleştirin
...
Diyalog, tüm iletişim problemlerinin çözümü. Çalışanlar arasındaki diyalogları geliştirmenin iş yerindeki çatışma ve gerilimleri azaltma konusunda da büyük yararları bulunur. Tüm çalışanlarınızın farklı ekiplere ayrılabileceği eğitimler, uygulamalar ve motivasyon artırıcı etkinlikler düzenleyerek şirket içi iletişimi maksimum seviyeye çıkarabilirsiniz. Şirket çalışanlarının tamamının katılacağı etkinlikler sayesinde aşağıdaki faydaları elde edebilirsiniz.

*   Çalışanlarınızın birbirlerini daha yakından tanımasını sağlayabilirsiniz.
*   Etkinliklerde birbirleriyle eşleşen çalışanların aralarındaki dostluk bağını güçlendirebilirsiniz.
*   Şirket içindeki gruplaşmaları dağıtarak toplam bir sinerji elde edebilirsiniz.
*   İlerleyen günlerde yaşanacak fikir ayrılıklarında çalışanların birbirlerine daha ılımlı yaklaşmasını sağlayabilirsiniz.

İşletme içi iletişim ve motivasyonu artırmanın ve çatışmayı önlemenin bir diğer yolu ise yönetim olarak çalışanlardan geri bildirim almaktır. Akıllı İK yazılımı **[Idenfit Geri Bildirim Modülü](/organizasyonel-geri-bildirim-modulu/)**, çalışanlarınıza dilediğiniz soruları sormanızı ve çalışanların cevaplarını eğlenceli temalar üzerinden vermesine olanak sağlar. Elde edilen sonuçlara göre iyileştirmeler, takım çalışmaları ve sosyal etkinlikler planlanabilir ya da öncesinde çatışmaya zemin hazırlayan konular tespit edilebilir.

## 5) Hızlı Aksiyon Alın
...
## 6) Radikal Kararlar Almaktan Korkmayın
...
## 7) Sorunları Halının Altına Süpürmeyin
